...
I'm Yashika from QVSCL (Gurugram), a strategic advisory firm working with high-growth early-stage ventures. We are currently raising a round for a climate-focused agritech platform that is building a full-stack renewable energy marketplace for rural India.
...
Yashika Gupta,
Analyst,
SIG_LINK_LABEL:LinkedIn:https://www.linkedin.com/in/yashika-gupta-22a009249/
8920871574
...
def add_template():
    ...
    if row:
        print(f"Updating existing template {name}...")
        ...
        cur.execute("INSERT INTO prompts (name, content, description, prompt_type, is_active) VALUES (%s, %s, %s, 'CUSTOM_DRAFT', TRUE);", (name, content, description))
